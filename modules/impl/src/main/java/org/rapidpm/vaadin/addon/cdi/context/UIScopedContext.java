...
import org.rapidpm.vaadin.addon.cdi.BeanProvider;
import org.rapidpm.vaadin.addon.cdi.annotation.UIScoped;
...
public class UIScopedContext extends AbstractContext {
    ...
    public void init(BeanManager beanManager) {
        contextualStorageManager = BeanProvider.getContextualReference(beanManager, ContextualStorageManager.class, false);
    }
