...
import org.rapidpm.vaadin.addon.cdi.CdiVaadinServlet;
...
public class VaadinServiceScopedContext extends AbstractContext {
    ...
    public void init(BeanManager beanManager) {
        contextManager = BeanProvider.getContextualReference(beanManager, ContextualStorageManager.class, false);
    }
